...
int main()
{
    ...
    {
        scheduler_priority_inheritance(prioty_inheritance_task_set,resource_list_object,RM);
    }
    else if(scheduling_algo==1)
    {
        scheduler_priority_inheritance(prioty_inheritance_task_set,resource_list_object,EDF);
    }
